...
<!--        <div class="relative isolate overflow-hidden bg-white px-6 py-24 rounded sm:py-32 lg:overflow-visible lg:px-0">-->
...
<!--                            <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Manage Your Sports Teams with Ease</h1>-->
            ...
            <div class="relative isolate overflow-hidden bg-white px-6 py-24 rounded sm:py-32 lg:overflow-visible lg:px-0">
                <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
                    <div class="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                        <div class="lg:pr-4">
                            <div class="lg:max-w-lg">
                                <p class="text-base font-semibold leading-7 text-indigo-600">Welcome to the show!</p>
                                <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Manage Your Sports Teams and Leagues with Ease</h1>
                                <p class="mt-6 text-xl leading-8 text-gray-700">Simplify your tournament and league management with our powerful platform. Keep track of your teams, matches, scores, and much more!</p>
                            </div>
                        </div>
                    </div>
                    <div class="-ml-12 -mt-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
                    ...
                    <div class="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                        <div class="lg:pr-4">
                            <div class="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
                                <p>Take control of your sports tournaments and leagues with our user-friendly platform. Whether you organize football, basketball, or any other sports events, we've got you covered.</p>
                                <ul role="list" class="mt-8 space-y-8 text-gray-600">
                                    <li class="flex gap-x-3">
                                        <svg class="mt-1 h-5 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            <path fill-rule="evenodd" d="M5.5 17a4.5 4.5 0 01-1.44-8.765 4.5 4.5 0 018.302-3.046 3.5 3.5 0 014.504 4.272A4 4 0 0115 17H5.5zm3.75-2.75a.75.75 0 001.5 0V9.66l1.95 2.1a.75.75 0 101.1-1.02l-3.25-3.5a.75.75 0 00-1.1 0l-3.25 3.5a.75.75 0 101.1 1.02l1.95-2.1v4.59z" clip-rule="evenodd" />
                                        </svg>
                                        <span><strong class="font-semibold text-gray-900">Effortless tournament management.</strong> Organize and schedule matches, manage teams, and view live scores seamlessly.</span>
                                    </li>
                                    <li class="flex gap-x-3">
                                        <svg class="mt-1 h-5 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            <path fill-rule="evenodd" d="M10 1a4.5 4.5 0 00-4.5 4.5V9H5a2 2 0 00-2 2v6a2 2 0 002 2h10a2 2 0 002-2v-6a2 2 0 00-2-2h-.5V5.5A4.5 4.5 0 0010 1zm3 8V5.5a3 3 0 10-6 0V9h6z" clip-rule="evenodd" />
                                        </svg>
                                        <span><strong class="font-semibold text-gray-900">Secure and reliable.</strong> Rest assured with our SSL certificates and regular database backups.</span>
                                    </li>
                                    <li class="flex gap-x-3">
                                        <svg class="mt-1 h-5 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            <path d="M4.632 3.533A2 2 0 016.577 2h6.846a2 2 0 011.945 1.533l1.976 8.234A3.489 3.489 0 0016 11.5H4c-.476 0-.93.095-1.344.267l1.976-8.234z" />
                                        ...
                                        <span><strong class="font-semibold text-gray-900">Easy-to-use interface.</strong> Our platform is designed to be user-friendly, making management tasks a breeze.</span>
                                    </li>
                                </ul>
                                <p class="mt-8">Start managing your sports events today and enjoy the simplicity of our system. No more server worries – we've got it all covered!</p>
                                <h2 class="mt-16 text-

2xl font-bold tracking-tight text-gray-900">Ready to get started?</h2>
                                <p class="mt-6">Sign up now and take your sports tournament and league management to the next level. Join the thousands of organizers who already trust us with their events.</p>
                            </div>
                        </div>
                    </div>
                </div>
